...
function emptyBrief(context: AmbientRuntimeContext, horizon: AmbientHorizon, reason: string): AmbientAttentionBrief {
  return { organization_id: context.organizationId, owner_user_id: context.userId, horizon, context_status: "insufficient", insufficiency_reason: reason, focus_statement: null, priority_items: [], do_items: [], delegate_items: [], stop_items: [], source_observation_ids: [], generated_by: "human_reviewed_service" };
}

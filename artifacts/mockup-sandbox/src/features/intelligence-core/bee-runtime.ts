...
export async function loadBeeRuntimeSource(context: BeeRuntimeContext): Promise<BeeRuntimeSource> {
  ...
  const [signals, evidence, recommendations, interventions, actions, outcomes, beeActionRequests, knowledgeSources, knowledgeDocuments, organizationalMemoryRelations, organizationalEvents, decisions, decisionInterventions, decisionRevisions, organizationalReadings, organizationalReadingSources, organizationalReadingHypotheses, evidenceAssessments, assessmentEvidence, recommendationReadings, recommendationAssessments, recommendationHypotheses, recommendationEvidence, recommendationRevisions] = await Promise.all([
    safe(() => readSignals(contexts.intelligence)), safe(() => readEvidence(contexts.intelligence)), safe(() => readRecommendations(contexts.intelligence)), safe(() => readInterventions(contexts.intelligence)), safe(() => readActions(contexts.intelligence)), safe(() => readOutcomes(contexts.intelligence)), safe(() => readBeeActionRequests(contexts.intelligence)), safe(() => readKnowledgeSources(contexts.intelligence)), safe(() => readKnowledgeDocuments(contexts.intelligence)), safe(() => readOrganizationalMemoryRelations(contexts.intelligence)), safe(() => readOrganizationalEvents(contexts.intelligence)), safe(() => readDecisions(contexts.intelligence)), safe(() => readDecisionInterventions(contexts.intelligence)), safe(() => readDecisionRevisions(contexts.intelligence)), safe(() => readOrganizationalReadings(contexts.intelligence)), safe(() => readOrganizationalReadingSources(contexts.intelligence)), safe(() => readOrganizationalReadingHypotheses(contexts.intelligence)), safe(() => readEvidenceAssessments(contexts.intelligence)), safe(() => readAssessmentEvidence(contexts.intelligence)), safe(() => readRecommendationReadings(contexts.intelligence)), safe(() => readRecommendationAssessments(contexts.intelligence)), safe(() => readRecommendationHypotheses(contexts.intelligence)), safe(() => readRecommendationEvidence(contexts.intelligence)), safe(() => readRecommendationRevisions(contexts.intelligence)),
  ]);
  const dho = await readDhoContext(contexts.dho);
  return { ...emptySource(), signals, evidence, recommendations, interventions, actions, outcomes, beeActionRequests, knowledgeSources, knowledgeDocuments, organizationalMemoryRelations, organizationalEvents, decisions, decisionInterventions, decisionRevisions, organizationalReadings, organizationalReadingSources, organizationalReadingHypotheses, evidenceAssessments, assessmentEvidence, recommendationReadings, recommendationAssessments, recommendationHypotheses, recommendationEvidence, recommendationRevisions, dhoContext: dho.items, dhoAvailability: dho.sources };
}
